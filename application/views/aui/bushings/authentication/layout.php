...
<body>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-12 text-center">
					<h2 class="heading-section"><?php echo strtoupper('bushing.sdzp.pp.ua'); ?></h2>
				</div>
			</div>
			<noscript>
				<div class="row justify-content-center">
	...
	<?php if (isset($page) && $page === 'signin'): ?>
		<script src="/assets/js/pages/bushings/signin.js"></script>
	<?php endif; ?>
	<?php if (isset($page) && $page === 'signup'): ?>
		<script src="/assets/js/pages/bushings/signup.js"></script>
	<?php endif; ?>
	<?php if (isset($page) && $page === 'forgot'): ?>
		<script src="/assets/js/pages/bushings/forgot.js"></script>
	<?php endif; ?>
</body>
</html>
